...
class DataBinderMapperImpl extends android.databinding.DataBinderMapper {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                case com.example.stani.lesson8.R.layout.activity_login:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/activity_login_0".equals(tag)) {
                            return new com.example.stani.lesson8.databinding.ActivityLoginBinding(bindingComponent, view);
                    }
        ...
        switch(code) {
            case -237232145: {
                if(tag.equals("layout/activity_login_0")) {
                    return com.example.stani.lesson8.R.layout.activity_login;
                }
                break;
            }
        }
